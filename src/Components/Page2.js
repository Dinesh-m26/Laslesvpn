...
export const Page2 = () => {
    return (
        <div id="pricing" className='my-2 md:my-24 '>
            ...
            <div className='md:flex justify-around mt-4 md:mt-14 '>
                <div className='flex-wrap mb-4 md:mb-0 md:w-1/4 border-2 border-[#DDDDDD] hover:border-[#F53838] rounded-lg '>
                    <img src={free} className='mx-auto mt-7 lg:mt-16' />
                ...
                <div className='flex-wrap mb-4 md:mb-0  md:w-1/4 border-2 border-[#DDDDDD] hover:border-[#F53838] rounded-lg '>
                    <img src={standard} className='mx-auto mt-7 lg:mt-16' />
                ...
                <div className='flex-wrap mb-4 md:mb-0  md:w-1/4 border-2 border-[#DDDDDD] hover:border-[#F53838] rounded-lg'>
                    <img src={premium} className='mx-auto mt-7 lg:mt-16' />
