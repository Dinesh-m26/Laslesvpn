            ...
            <div className='flex mt-2 md:mt-8 lg:mt-18 '>
                <div className='w-full lg:w-1/2 mt-5 lg:mt-20'>
                    <div className=' text-[#0B132A] font-medium text-2xl md:text-5xl '>
                        ...
                        <p className='lg:mt-2'>easy with <span className='font-bold'>LaslesVPN.</span></p>
                    </div>
                    <div className='mt-2 md:mt-5 text-[#4F5665] font-medium text-xs md:text-base'>
                        <p >Provide a network for all your needs with ease and fun using <span className='font-bold'> LaslesVPN</span> <span className='md:hidden'>discover interesting features from us.</span></p>
